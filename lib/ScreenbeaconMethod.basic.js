...
var screenbeaconMethod = require('./ScreenbeaconMethod');
var utils = require('./utils');

module.exports = {

  create: screenbeaconMethod({
    method: 'POST'
  }),

  list: screenbeaconMethod({
    method: 'GET'
  }),

  retrieve: screenbeaconMethod({
    method: 'GET',
    path: '/{id}',
    urlParams: ['id']
  }),

  update: screenbeaconMethod({
    method: 'PATCH',
    path: '{id}',
    urlParams: ['id']
  }),
