 ...
 */
module.exports = function screenbeaconMethod(spec) {
  ...
  return function() {
    ...
    for (var i = 0, l = urlParams.length; i < l; ++i) {
      ...
      if (!arg) {
        ...
        throw new Error('Screenbeacon: I require argument "' + urlParams[i] + '", but I got: ' + arg);
      }
    ...
    if (args.length) {
      throw new Error(
        'Screenbeacon: Unknown arguments (' + args + '). Did you mean to pass an options object? ' +
        'See https://github.com/screenbeacon/screenbeacon-node'
      );
    }
